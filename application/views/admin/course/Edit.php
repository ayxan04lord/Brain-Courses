        ...
        <main class="py-6 bg-surface-secondary">
            <div class="container-fluid">
                ...
                <div class="card shadow border-0 mb-7">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('admin/course_create_act'); ?>" method="POST" enctype="multipart/form-data" id="course_form">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="course_description" id="course_description" rows="9" class="form-control"><?php echo $course_data['c_title']; ?></textarea>
                                    <div class="row mt-3">
