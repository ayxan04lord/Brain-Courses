            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Detail <a href="<?php echo base_url('admin_course_list'); ?>"><button type="button" style="float:right" class="btn btn-primary">Back</button></a></h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTablea" width="100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $course_data['c_title_az']; ?></td>
                                </tr>

                                <tr>
                                    <th>Title en</th>
                                    <td><?php echo $course_data['c_title_en']; ?></td>
                                </tr>

                                <tr>
                                    <th>Title ru</th>
                                    <td><?php echo $course_data['c_title_ru']; ?></td>
                                </tr>

                                <tr>
                                    <th>Description az</th>
                                    <td><?php echo $course_data['c_desc_az']; ?></td>
                                </tr>

                                <tr>
                                    <th>Description en</th>
                                    <td><?php echo $course_data['c_desc_en']; ?></td>
                                </tr>

                                <tr>
                                    <th>Description ru</th>
                                    <td><?php echo $course_data['c_desc_ru']; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <th>Status</th>
                                    <?php if ($course_data['c_status'] == "Active") { ?>
                                ...
                                <tr>
                                    <th>Profile</th>
                                    <?php if ($course_data['c_img']) { ?>
                                        <td><img width="150px" src="<?php echo base_url('uploads/courses/' . $course_data['c_img']); ?>" alt=""></td>
                                    <?php } else { ?>
