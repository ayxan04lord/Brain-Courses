            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Detail <a href="<?php echo base_url('admin_partners_list'); ?>"><button type="button" style="float:right" class="btn btn-primary">Back</button></a></h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTablea" width="100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $partners_data['p_title_az']; ?></td>
                                </tr>

                                <tr>
                                    <th>Title en</th>
                                    <td><?php echo $partners_data['p_title_en']; ?></td>
                                </tr>

                                <tr>
                                    <th>Title ru</th>
                                    <td><?php echo $partners_data['p_title_ru']; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <th>Link</th>
                                    <td><?php echo $partners_data['p_link']; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <th>Img</th>
                                    <?php if ($partners_data['p_img']) { ?>
                                        <td><img width="150px" src="<?php echo base_url('uploads/partners/' . $partners_data['p_img']); ?>" alt=""></td>
                                    <?php } else { ?>
