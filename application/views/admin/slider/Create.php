                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane container fade" id="menu2">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="slider_title_ru" class="form-control" id="slider_title_ru" placeholder="Enter Title name">
                                            </div>

                                            <div class="col-md-12">
                                                <label for="slider_description_ru">Slider Description RUS</label>
                                                <textarea name="slider_description_ru" id="slider_description_ru" rows="9" class="form-control"></textarea>
                                                <script>
