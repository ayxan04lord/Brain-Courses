         ...
         <div class="header_bg">
            <div class="container">
               <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  <a class="logo" href="index.html"><img src="<?php echo base_url('public/assets/'); ?>images/logo.png"></a>
            ...
            <div class="footer_section_2">
               <div class="row">
                  <div class="col-lg-3 col-md-6 margin_top">
                     <div class="call_text"><a href="#"><img src="<?php echo base_url('public/assets/'); ?>images/call-icon1.png"><span class="padding_left_15">Call Now +01 9876543210</span></a></div>
                     <div class="call_text"><a href="#"><img src="<?php echo base_url('public/assets/'); ?>images/mail-icon1.png"><span class="padding_left_15">demo@gmail.com</span></a></div>
                  </div>
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="information_main">
                        <div class="footer_logo"><a href="index.html"><img src="<?php echo base_url('public/assets/'); ?>images/footer-logo.png"></a></div>
                     </div>
                  </div>
               </div>
            </div>
